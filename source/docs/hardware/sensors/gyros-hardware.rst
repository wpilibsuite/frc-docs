...
.. image:: images/gyros-hardware/analog-devices-frc-gyro-to-roborio.svg
  :alt: Shows the Analog Devices 1-axis Gyro plugged into the SPI port of the roboRIO.
  :width: 400
...
.. image:: images/gyros-hardware/drive-yaw-pitch-roll.svg
  :alt: This shows each of the 3 axis: yaw, pitch, and roll and how they relate to robot movement.
  :width: 400
