...
.. note:: The PDP 2.0 does not have buit in current logging and current logs will not be availible in the :doc:`Driver Station Log Viewer </docs/software/driverstation/driver-station-log-viewer>`
...
.. note:: The AMPD does not have buit in current logging and current logs will not be availible in the :doc:`Driver Station Log Viewer </docs/software/driverstation/driver-station-log-viewer>`
