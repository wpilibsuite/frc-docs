...
.. important:: WPILib installs a separate version of VS Code than into an already existing installation. Please launch the WPILib VS Code and not a system installed copy!
