...
.. note:: This section details how to wire the SPARK MAX controllers using PWM signaling. Many FRC motor controllers can also be wired using :ref:`CAN<docs/hardware/hardware-basics/can-wiring-basics:CAN Wiring Basics>`.
