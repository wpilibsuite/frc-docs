...
.. image:: images/radio-programming/VH-109-2-radios.drawio.svg
   :alt: Connectiuvity diagram of VH-109 on robot connected to VH-109 on Driver station, powered by VH-117 POE wall addapter, with DS and programming laptops connected to it
