...
- :doc:`Proximity switches </docs/hardware/sensors/proximity-switches>`
...
- Distance sensors
   ...
   * :doc:`Triangulating rangefinders </docs/hardware/sensors/triangulating-rangefinders>`
   * :doc:`LIDAR </docs/hardware/sensors/lidar>`

- Shaft rotation sensors
   * :doc:`Encoders </docs/hardware/sensors/encoders-hardware>`
   * :doc:`Potentiometers </docs/hardware/sensors/analog-potentiometers-hardware>`

- :doc:`Accelerometers </docs/hardware/sensors/accelerometers-hardware>`

- :doc:`Gyroscopes </docs/hardware/sensors/gyros-hardware>`
...
- :doc:`Analog input </docs/hardware/sensors/analog-inputs-hardware>`
- :doc:`Digital input </docs/hardware/sensors/digital-inputs-hardware>`
- :doc:`Serial bus </docs/hardware/sensors/serial-buses>`
