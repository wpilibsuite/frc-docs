...
- Relevant. Documentation should be focused on WPILib, FRC\ |reg| or FTC\ |reg|.

Please see the :ref:`docs/contributing/wpilib-docs/style-guide:Style Guide` for information on styling your documentation.

## Release Process

wpilib-docs uses a special release process for handling the main site ``/stable/`` and the development site ``/latest/``. This flow is detailed below.
