...
.. note:: For the 2022 FRC\ |reg| Beta Test, some of you may not have access to physical robot hardware. We recognize this will inhibit your ability to complete some tasks. Teams without hardware should skip Task 2, merely ensure they can build their 2020/21 robot code for Task 3 and focus on Task 4, testing new features to the extent possible using simulation.
...
Task 3 - Port Previous Robot Code (Targeted Completion 11/12/2021)
------------------------------------------------------------------
