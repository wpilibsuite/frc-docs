...
The purpose of this task is to test any newly developed or heavily modified features for the new season. This will help the Control System team find any bugs or issues with the new code. A complete description of changes for 2020 can be found in the :doc:`/docs/software/vscode-overview/new-for-2020` document. Below is a list of some of the new or modified features to focus on:
