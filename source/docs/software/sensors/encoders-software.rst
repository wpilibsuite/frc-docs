...
.. important:: The encoder class is only used for encoders that are plugged directly in the roboRIO! Please reference the appropriate vendors documentation for using encoders plugged into motor controllers.
