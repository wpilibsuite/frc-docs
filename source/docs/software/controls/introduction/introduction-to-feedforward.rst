...
.. note:: For a guide on implementing feedforward control in code with WPILib, see :ref:`docs/software/controls/controllers/feedforward:Feedforward Control in WPILib`.
