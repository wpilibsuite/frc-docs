...
This heap dump will be stored on the target system (SystemCore) and must be retrieved using SFTP. See :doc:`this article </docs/software/systemcore-info/systemcore-ftp>` for information on retrieving the dump from the SystemCore.
