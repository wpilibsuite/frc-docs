...
The ``DriverStation`` class ([Java](https://github.wpilib.org/allwpilib/docs/2027/java/org/wpilib/driverstation/DriverStation.html), [C++](https://github.wpilib.org/allwpilib/docs/2027/cpp/classwpi_1_1_driver_station.html), :py:class:`Python <robotpy:wpilib.DriverStation>`) has many useful features for getting data from the Driver Station computer.  One of the most important features is ``getAlliance`` (Java & Python) / ``GetAlliance`` (C++).
