...
- The various classes for predefined dimensions, such as [DistanceUnit](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/units/DistanceUnit.html) and [TimeUnit](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/units/TimeUnit.html)
- [Units](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/units/Units.html), which contains a set of predefined units. Take a look a the [Units javadoc](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/units/Units.html) to browse the available units and their types.
- [Measure](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/units/Measure.html), which is used to tag a value with a unit, and the dimension-specific implementations like [Distance](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/units/measure/Distance.html) and [Time](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/units/measure/Time.html)
