...
Download the example *FIRST* Destination Deep Space field definition :download:[here](files/DeepSpace.zip). Other field definitions are available in the [allwpilib GitHub repository](https://github.com/wpilibsuite/allwpilib/tree/2027/fieldImages/src/main/native/resources/edu/wpi/first/fields).
