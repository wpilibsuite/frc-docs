...
.. warning:: Many vendors (like CTRE & REV) with additional programs to aid in the use of thier libraries prefer the offline installer.  Click these links to visit the vendor site to see whether they offer online installers, offline installers, or both.

URLs below are to plug in to the :guilabel:`VS Code` -> :guilabel:`Install New Libraries (online)` feature.
