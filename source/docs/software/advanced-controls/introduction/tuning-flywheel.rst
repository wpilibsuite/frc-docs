...
In this section, we will tune a simple velocity controller for a flywheel.  The same tuning principles explained here will also work for almost any velocity control scenario.
...
.. note:: Even though WPILib tooling can provide you with optimal gains, it is worth going through the manual tuning process to see how the different control strategies interact with the mechanism.
...
There are no tuneable controller parameters for a bang-bang controller - you can only adjust the setpoint. This simplicty is their strength, and also their weakness.
...
Feedforward and Static Friction
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
