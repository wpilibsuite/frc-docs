...
.. note:: This article is taken out of `Controls Engineering in FRC\ |reg| <https://file.tavsys.net/control/controls-engineering-in-frc.pdf>`__ by Tyler Veness with permission.
