...
Slew rate limiting is supported in WPILib through the ``SlewRateLimiter`` class (`Java <https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/math/filter/SlewRateLimiter.html>`__, `C++ <https://github.wpilib.org/allwpilib/docs/beta/cpp/classfrc_1_1_slew_rate_limiter.html>`__).
