...
Slew rate limiting is supported in WPILib through the ``SlewRateLimiter`` class ([Java](https://github.wpilib.org/allwpilib/docs/2027/java/org/wpilib/math/filter/SlewRateLimiter.html), [C++](https://github.wpilib.org/allwpilib/docs/2027/cpp/classwpi_1_1math_1_1_slew_rate_limiter.html), :external:py:class:`Python <wpimath.filter.SlewRateLimiter>`).
