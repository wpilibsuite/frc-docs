...
WPILib provides 2 classes, ``Transform2d`` ([Java](https://github.wpilib.org/allwpilib/docs/2027/java/edu/wpi/first/math/geometry/Transform2d.html), [C++](https://github.wpilib.org/allwpilib/docs/2027/cpp/classfrc_1_1_transform2d.html), :external:py:class:`Python <wpimath.geometry.Transform2d>`), which represents a transformation to a pose, and ``Twist2d`` ([Java](https://github.wpilib.org/allwpilib/docs/2027/java/edu/wpi/first/math/geometry/Twist2d.html), [C++](https://github.wpilib.org/allwpilib/docs/2027/cpp/structfrc_1_1_twist2d.html), :external:py:class:`Python <wpimath.geometry.Twist2d>`) which represents a movement along an arc. ``Transform2d`` and ``Twist2d`` all have x, y and :math:`\theta` components.
