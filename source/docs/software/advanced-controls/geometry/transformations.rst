...
WPILib provides 2 classes, ``Transform2d`` (`Java <https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/math/geometry/Transform2d.html>`__, `C++ <https://github.wpilib.org/allwpilib/docs/beta/cpp/classfrc_1_1_transform2d.html>`__), which represents a transformation to a pose, and ``Twist2d`` (`Java <https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/math/geometry/Twist2d.html>`__, `C++ <https://github.wpilib.org/allwpilib/docs/beta/cpp/structfrc_1_1_twist2d.html>`__) which represents a movement along an arc. ``Transform2d`` and ``Twist2d`` all have x, y and :math:`\theta` components.
