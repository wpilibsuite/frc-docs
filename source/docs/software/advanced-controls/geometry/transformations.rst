...
WPILib provides 2 classes, ``Transform2d`` ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/math/geometry/Transform2d.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classwpi_1_1math_1_1_transform2d.html), :external:py:class:`Python <wpimath.geometry.Transform2d>`), which represents a transformation to a pose, and ``Twist2d`` ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/math/geometry/Twist2d.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/structwpi_1_1math_1_1_twist2d.html), :external:py:class:`Python <wpimath.geometry.Twist2d>`) which represents a movement along an arc. ``Transform2d`` and ``Twist2d`` all have x, y and :math:`\theta` components.
