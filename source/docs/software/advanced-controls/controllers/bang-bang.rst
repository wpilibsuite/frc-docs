...
Asymmetric bang-bang control is provided in WPILib by the BangBangController class ([Java](https://github.wpilib.org/allwpilib/docs/2027/java/org/wpilib/math/controller/BangBangController.html), [C++](https://github.wpilib.org/allwpilib/docs/2027/cpp/classwpi_1_1math_1_1_bang_bang_controller.html), :external:py:class:`Python <wpimath.controller.BangBangController>`).
...
.. tab-set-code::
  ...
  ```c++
  // Creates a BangBangController
  wpi::BangBangController controller;
  ```
