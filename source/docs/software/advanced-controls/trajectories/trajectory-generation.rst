...
.. note:: The Java code utilizes the `Units <https://github.wpilib.org/allwpilib/docs/development/java/edu/wpi/first/math/util/Units.html>`_ utility, for easy unit conversions.
