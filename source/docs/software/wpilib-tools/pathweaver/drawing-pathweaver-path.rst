...
.. image:: images/drawing-pathweaver-path/back-rocket.png
   :alt: A path starting on the HAB ending at the back side of the rocket.
...
.. image:: images/drawing-pathweaver-path/initial-trajectory.png
   :alt: An initial trajectory showing a single waypoint.
...
.. image:: images/drawing-pathweaver-path/waypoint-heading.png
   :alt: Dragging the teal line to change a give waypoint's heading.
...
.. image:: images/drawing-pathweaver-path/additional-waypoints.png
   :alt: Creating multiple waypoint allows the robot to follow more complex routes.
