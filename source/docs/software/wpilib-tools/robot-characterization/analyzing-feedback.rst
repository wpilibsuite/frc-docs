...
Entering Optimality Constraints
-------------------------------

Finally, the user must specify some constraints for what will be considered an "optimal" controller.  These take the form of desired tolerances for the system error and control effort - note that it is *not* guaranteed that the system will obey these tolerances at all times.

.. image:: images/optimalityconstraints.png
   :alt: Entering optimality constraints for the feedback controller
