...
.. image:: images/shuffleboard-commands-subsystems/elevator.png
   :alt: Widget for the elevator subsystem.
...
.. image:: images/shuffleboard-commands-subsystems/pid.png
   :alt: PIDController widget for the elevator subsystem.
...
.. image:: images/shuffleboard-commands-subsystems/grouped-commands.png
   :alt: A set of commands and buttons to execute each individually.
