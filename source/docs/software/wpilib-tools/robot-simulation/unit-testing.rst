...
.. tab-set::
   .. tab-item:: Java
      ...
      .. rli:: https://github.com/wpilibsuite/allwpilib/raw/v2025.1.1-beta-1/wpilibjExamples/src/main/java/edu/wpi/first/wpilibj/examples/unittest/subsystems/Intake.java
         :language: java
         :lines: 7-
   ...
   .. tab-item:: C++ (Header)
      ...
      .. rli:: https://github.com/wpilibsuite/allwpilib/raw/v2025.1.1-beta-1/wpilibcExamples/src/main/cpp/examples/UnitTest/include/subsystems/Intake.h
         :language: c++
         :lines: 7-
   ...
   .. tab-item:: C++ (Source)
      ...
      .. rli:: https://github.com/wpilibsuite/allwpilib/raw/v2025.1.1-beta-1/wpilibcExamples/src/main/cpp/examples/UnitTest/cpp/subsystems/Intake.cpp
         :language: c++
         :lines: 5-
...
.. tab-set::
   .. tab-item:: Java
      ...
      .. rli:: https://github.com/wpilibsuite/allwpilib/raw/v2025.1.1-beta-1/wpilibjExamples/src/test/java/edu/wpi/first/wpilibj/examples/unittest/subsystems/IntakeTest.java
         :language: java
         :lines: 7-
   ...
   .. tab-item:: C++
      ...
      .. rli:: https://github.com/wpilibsuite/allwpilib/raw/v2025.1.1-beta-1/wpilibcExamples/src/test/cpp/examples/UnitTest/cpp/subsystems/IntakeTest.cpp
         :language: c++
         :lines: 5-
