...
.. tab-set::
   ...
   .. tab-item:: Java/C++
      ...
      ********** Robot program starting **********
      ...
      If you would would like to prevent the pop up and only use build.gradle to configure your simulation settings you can change the setting “wpilib.skipSelectSimulateExtension" to true in your vscode settings.json file.
