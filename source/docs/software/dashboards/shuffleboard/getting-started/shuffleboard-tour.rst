...
-  You can extend Shuffleboard by writing your own widgets that are specific to your team's requirements. Documentation on extending it can be found in :doc:`Custom Widgets</docs/software/dashboards/shuffleboard/custom-widgets>`.
