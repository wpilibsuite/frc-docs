...
.. note:: You can retrieve the latest field image and JSON files from [here](https://github.com/wpilibsuite/allwpilib/tree/v2027.0.0-alpha-5/fields/src/main/native/resources/org/wpilib/fields).
