...
3. Click on the workspace, then the WPILib project that you imported in the :ref:`Setting Up the Data <docs/software/machine-learning/setting-up-the-data:Getting Data>` article.
