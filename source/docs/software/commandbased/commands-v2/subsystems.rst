...
For a comparison between these options, see the :ref:`Organizing Command-Based <docs/software/commandbased/commands-v2/organizing-command-based:Organizing Command-Based Robot Projects>` article.
