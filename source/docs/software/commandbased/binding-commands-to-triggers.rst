...
.. warning:: There is an issue with using JoystickButtons and POVButtons in C++. Take a look at the :ref:`known issues <docs/software/2020-overview/known-issues:C++ Command Based JoystickButton and POVButton not functioning>` page for more information.
