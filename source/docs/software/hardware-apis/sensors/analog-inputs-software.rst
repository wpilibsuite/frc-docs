...
Support for reading the voltages on the FPGA analog inputs is provided through the :code:`AnalogInput` class (`Java <https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/wpilibj/AnalogInput.html>`__, `C++ <https://github.wpilib.org/allwpilib/docs/beta/cpp/classfrc_1_1_analog_input.html>`__).
