...
The :code:`AnalogAccelerometer` class ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/wpilibj/AnalogAccelerometer.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classfrc_1_1_analog_accelerometer.html)) allows users to read values from a single-axis accelerometer that is connected to one of the roboRIO's analog inputs.
...
The :code:`ADXL345_I2C` class ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/wpilibj/ADXL345_I2C.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classfrc_1_1_a_d_x_l345___i2_c.html)) provides support for the ADXL345 accelerometer over the I2C communications bus.
...
The :code:`ADXL345_SPI` class ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/wpilibj/ADXL345_SPI.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classfrc_1_1_a_d_x_l345___s_p_i.html)) provides support for the ADXL345 accelerometer over the SPI communications bus.
...
The :code:`ADXL362` class ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/wpilibj/ADXL362.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classfrc_1_1_a_d_x_l362.html)) provides support for the ADXL362 accelerometer over the SPI communications bus.
...
The :code:`BuiltInAccelerometer` class ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/edu/wpi/first/wpilibj/BuiltInAccelerometer.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classfrc_1_1_built_in_accelerometer.html)) provides access to the roboRIO's own built-in accelerometer:
