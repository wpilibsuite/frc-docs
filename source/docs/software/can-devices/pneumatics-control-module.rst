...
The closed loop control of the Compressor and Pressure switch is handled by the :code:`Compressor` class ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/hardware/pneumatic/Compressor.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classwpi_1_1_compressor.html), :external:py:class:`Python <wpilib.Compressor>`), and the Solenoids are handled by the :code:`Solenoid` ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/hardware/pneumatic/Solenoid.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classwpi_1_1_solenoid.html), :external:py:class:`Python <wpilib.Solenoid>`) and :code:`DoubleSolenoid` ([Java](https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/hardware/pneumatic/DoubleSolenoid.html), [C++](https://github.wpilib.org/allwpilib/docs/beta/cpp/classwpi_1_1_double_solenoid.html), :external:py:class:`Python <wpilib.DoubleSolenoid>`) classes.
