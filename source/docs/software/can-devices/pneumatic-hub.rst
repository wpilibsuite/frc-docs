...
The Pneumatic Hub (PCH) is a CAN-based device that provides complete control over the compressor and up to 16 solenoids per module. The PCH is integrated into WPILib through a series of classes that make it simple to use.
...
An additional PCH module can be used where the modules corresponding solenoids are differentiated by the module number in the constructors of the Solenoid and Compressor classes.
