...
--------------------------------------
For the sake of ease for users, a ``RamseteCommand`` class is built in to WPILib. For a full tutorial on implementing a path-following autonomous using RamseteCommand, see :ref:`docs/software/examples-tutorials/trajectory-tutorial/trajectory-tutorial-overview:End-to-End Trajectory Tutorial`.
