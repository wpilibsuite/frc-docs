...
.. note::  For detailed instructions on using the FRC-Characterization tool, see its :ref:`dedicated documentation <docs/software/advanced-control/trajectories/robot-characterization/ntroduction:Introduction to Robot Characterization>`.
