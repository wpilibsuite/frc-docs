...
**Workaround:** Download a fixed version for your OS from `here <https://github.com/wpilibsuite/sysid/actions/workflows/build.yml?query=branch%3Amain>`__ (select the latest build and scroll down to "Artifacts").
